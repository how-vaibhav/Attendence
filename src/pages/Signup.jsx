...
export default function Signup() {
  ...
  async function handle(e) {
    ...
    try {
      // The signup function in AuthContext will handle the logic
      // to store the user and navigate to the correct dashboard
      await signup({ name, email, password, role });

      // Redirect to the appropriate dashboard based on the signed-up role
      if (role === "admin") {
        navigate("/dashboard");
      } else {
